...
public interface UserService {
    ...
    ChinogoResult checkUserData(/**@PathParam("param")*/String data, /**@PathParam("type")*/Integer type, String callback);
    ...
    //@POST
    //@Path("/register")
    ChinogoResult register(TbUser user);
    ...
    //@GET
    //@Path("/token/{token}")
    ChinogoResult token(/**@PathParam("token")*/String token);
    ...
    //@GET
    //@Path("/logout/{token}")
    ChinogoResult logout(/**@PathParam("token")*/String token);
