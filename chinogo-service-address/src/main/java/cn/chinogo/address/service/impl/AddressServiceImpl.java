package cn.chinogo.address.service.impl;

import cn.chinogo.address.service.AddressService;
 ...
 * @author chinotan
 */
@Service(version = Const.CHINOGO_ADDRESS_VERSION, timeout = 100000, retries = 0)
