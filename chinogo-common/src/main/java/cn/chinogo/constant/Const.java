...
public final class Const {
    ...
    /**cookie 用户登录token*/
    public static final String TOKEN_LOGIN = "_cgt";

    // Dubbox版本
    public static final String CHINOGO_REDIS_VERSION = "1.0.0";
    public static final String CHINOGO_ADDRESS_VERSION = "1.0.0";
    public static final String CHINOGO_SSO_VERSION = "1.0.0";
    public static final String CHINOGO_NOTIFY_VERSION = "1.0.0";
    public static final String CHINOGO_CATEGORY_VERSION = "1.0.0";
    public static final String CHINOGO_SEARCH_VERSION = "1.0.0";
    public static final String CHINOGO_CONTENT_VERSION = "1.0.0";
    public static final String CHINOGO_ORDER_VERSION = "1.0.0";
    public static final String CHINOGO_CART_VERSION = "1.0.0";
    public static final String CHINOGO_ITEM_VERSION = "1.0.0";
